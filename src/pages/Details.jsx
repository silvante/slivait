    ...
    <div className="p-5 space-y-5 flex flex-col items-center w-full">
      ...
      <div className="flex w-full justify-between gap-5">
        <div className="w-[40%] border-2 border-white/15 rounded-lg overflow-hidden relative">
          <a href={slivait.img} download className="absolute bg-blueSans shadow-btn rounded-full px-3 py-1 top-2 left-2"><i className='bx bxs-download'></i> download picture</a>
